...
# Professional light theme with high visibility
st.markdown("""
    <style>
        :root {
            --primary: #2563EB;
...
# (Keep all your existing backend code exactly the same)
# ======================
...
# ======================
# 3. AUTHENTICATION UI (LIGHT MODE)
# ======================
def show_auth_ui():
    st.markdown("""
